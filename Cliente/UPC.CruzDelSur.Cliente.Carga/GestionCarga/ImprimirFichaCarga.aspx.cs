    ...
    public partial class ImprimirFichaCarga : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["idProgramacionRuta2"] != null)
            {
                ...
                BE_Programacion_Ruta oBE_Programacion_Ruta = oBL_Programacion_Ruta.f_UnoProgramacion_Ruta(Int32.Parse(Session["idProgramacionRuta2"].ToString()));
            ...
            if (Session["idRemitente2"] != null)
            {
                ...
                BE_Cliente oCliente = oBL_Cliente.f_UnoCliente(Session["idRemitente2"].ToString());
            ...
            if (Session["idDestinatario2"] != null)
            {
                ...
                BL_Cliente oBL_Cliente = new BL_Cliente();
                BE_Cliente oCliente = oBL_Cliente.f_UnoCliente(Session["idDestinatario2"].ToString());
            ...
            if (Session["ListaProducto2"] != null)
            {
                ListaProducto = (List<BE_DetalleCarga>)Session["ListaProducto2"];
            }
            else
            {
            ...
            if (Session["idProducto2"] != null)
            {
                ...
                BE_Producto oBE_Producto = oBL_Producto.f_ListadoUnoProducto(Int32.Parse(Session["idProducto2"].ToString()));
